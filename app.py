...
# ============================================================================
# ORIGINAL PROFESSIONAL COLOR PALETTE
# ============================================================================
COLOR_PALETTE = {
...
# ============================================================================
# CUSTOM CSS (DYNAMIC – UPDATES WITH DARK MODE)
# ============================================================================
...
def get_plotly_layout():
    """Return layout settings for Plotly figures based on current mode"""
    if st.session_state.dark_mode:
        return {
        ...
        return {
            'paper_bgcolor': 'white',
            'plot_bgcolor': 'white',
            'font': {'color': COLOR_PALETTE['text_light']},
...
# Load CSS after sidebar (so dark_mode is known)
load_original_css()
        ...
        with col2:
            if st.button("📥 Export CSV"):
                ...
                st.download_button(
                    label="Download CSV",
                    data=csv,
                    file_name=f"sales_{datetime.now():%Y%m%d_%H%M%S}.csv",
                    mime="text/csv"
                )
        with col3:
